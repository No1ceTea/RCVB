...
?>
    ...
    <form method="post" action="../../controller/modifProfil.php" enctype="multipart/form-data">
        ...
        <input type="tel" value="<?php echo $res['telephone'];?>" pattern="[0]{1}[0-9]{1} [0-9]{2} [0-9]{2} [0-9]{2} [0-9]{2}" onFocus="this.value='';" name="telephone" required>
        <input type="text" value=<?php echo $res['poste'];?> name="poste" onFocus="this.value='';" readonly="readonly">
